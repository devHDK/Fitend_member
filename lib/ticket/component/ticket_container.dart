      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        product.name,
                        style:
                            s2SubTitle.copyWith(color: Colors.white, height: 1),
                      ),
                      const SizedBox(
                        width: 10,
                      ),
                      Text(
                        ...
                        style:
                            h5Headline.copyWith(color: Colors.white, height: 1),
                      ),
                      const SizedBox(
                        width: 10,
                      ),
            ...
            GestureDetector(
              onTap: () {
                print(model.data[model.selectedIndex!].toJson());
              },
              child: Container(
                height: 44,
                decoration: BoxDecoration(
