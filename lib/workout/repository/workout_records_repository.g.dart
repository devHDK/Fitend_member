...
part of 'workout_records_repository.dart';
...
class _WorkoutRecordsRepository implements WorkoutRecordsRepository {
  ...
  Future<WorkoutResultModel> getWorkoutResults(
      {required GetWorkoutRecordsParams params}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  Future<WorkoutHistoryModel> getWorkoutHistory(
      {required GetWorkoutHistoryParams params}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.addAll(params.toJson());
    final _headers = <String, dynamic>{r'accessToken': 'true'};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<WorkoutHistoryModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = WorkoutHistoryModel.fromJson(_result.data!);
    return value;
  }
